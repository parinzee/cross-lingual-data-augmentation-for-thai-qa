...
def paraphrase():
    ...
    for i in tqdm.tqdm(range(0, len(df), 25), desc="Paraphrasing questions"):
        ...
        for idx, paraphrased in enumerate(paraphrases):
            data.append({
                "id": batch.iloc[idx]["id"],
                "en_llm_paraphrase_aug": paraphrased
            })
